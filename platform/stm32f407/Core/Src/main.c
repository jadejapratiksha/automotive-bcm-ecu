...
int main(void)
{
  ...
  LightingTaskHandle = osThreadNew(StartLightingTask, NULL, &LightingTask_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(INTERIOR_LAMP_OUT_GPIO_Port, INTERIOR_LAMP_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : DOOR_FL_IN_Pin */
  GPIO_InitStruct.Pin = DOOR_FL_IN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(DOOR_FL_IN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : INTERIOR_LAMP_OUT_Pin */
  GPIO_InitStruct.Pin = INTERIOR_LAMP_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(INTERIOR_LAMP_OUT_GPIO_Port, &GPIO_InitStruct);
...
/* USER CODE BEGIN Header_StartLightingTask */
/**
* @brief Function implementing the LightingTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLightingTask */
void StartLightingTask(void *argument)
{
